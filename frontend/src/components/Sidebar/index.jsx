...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute shadow-2xl left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-[#51328F] duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img
            className="w-13 h-full rounded-3xl shadow-lg border"
            src="https://lh3.googleusercontent.com/a/ACg8ocLXbBosz--tMXJZ9UIBHS9j8utVyCIibBPMR6D5xt3Q0w=s100"
            alt="Logo"
          />
        </NavLink>
        <div>
          <h3 className="text-[#fff] font-medium text-md uppercase">
            Inspiration App
          </h3>
        </div>
        <button
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h4 className="mb-4 ml-4 text-sm font-semibold text-bodydark2">
              MENU
            </h4>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/dashboard"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-normal duration-300 ease-in-out hover:bg-[#ccc] hover:text-[#000] dark:hover:bg-meta-4 ${
                    pathname.includes('dashboard')
                      ? 'bg-[#fff] text-[#000] rounded-2xl font-medium dark:bg-meta-4 dark:text-[#ccc]'
                      : 'text-white'
                  }`}
                >
                  <svg
                  ...
                  <NavLink
                    ...
                    className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-normal  duration-300 ease-in-out hover:bg-[#ccc] hover:text-[#000] dark:hover:bg-meta-4 ${
                      pathname.includes('admin')
                        ? 'bg-[#fff] text-[#000] font-medium  rounded-2xl dark:bg-meta-4 dark:text-[#ccc]'
                        : 'text-white'
                    }`}
                  >
                    <svg
